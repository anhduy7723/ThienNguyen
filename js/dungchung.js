...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ Thiện Nguyện" title="Trang chủ Thiện Nguyện">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">LDD Phone Store</a> - All rights reserved © 2023 - Designed by
            <span style="color: #eee; font-weight: bold">Trường THCS Nguyễn Huệ</span></p>
    </div>`);
}
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0975212702" style="color: #288ad6;">0975212702</a>
                </li>
            </ul>
        </section>
    </div>`);
